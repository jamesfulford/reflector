...
public class DIAG {
    ...
    public static void pung(int a) {
        System.out.println("Pung! Ln " + a);
    }

    //      SAY METHODS (should be able to say anything, any dimension array, recursively. I hope.)
    ...
    //should now be able to handle any size array. Maybe one method too many. Many it doesn't work as I think it does.
    ...
    public static void val(boolean bool, String name) {
        if (bool) {
            ...
            System.out.println(name + " is FALSE!");
        }
    }
